...
function $c_Lmyapp_Counter$() {
  ...
  this.Lmyapp_Counter$__f_component = $j_myapp$002efunction$002dComponent$0024package$0024.$m_Lmyapp_functionComponent$package$().functionComponent__T__sjs_js_Function1__sjs_js_Any("Counter", ((p) => {
    matchResult1: {
      var \u03b42$;
