...
$c_Lmyapp_components_TextInput$.prototype.constructor = $c_Lmyapp_components_TextInput$;
/** @constructor */
function $h_Lmyapp_components_TextInput$() {
}
...
export { $d_Lmyapp_components_TextInput$ as $d_Lmyapp_components_TextInput$ };
var $n_Lmyapp_components_TextInput$;
function $m_Lmyapp_components_TextInput$() {
  if ((!$n_Lmyapp_components_TextInput$)) {
    $n_Lmyapp_components_TextInput$ = new $c_Lmyapp_components_TextInput$();
  }
  return $n_Lmyapp_components_TextInput$;
}
export { $m_Lmyapp_components_TextInput$ as $m_Lmyapp_components_TextInput$ };
