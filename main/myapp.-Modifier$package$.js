...
$c_Lmyapp_Modifier$package$.prototype.constructor = $c_Lmyapp_Modifier$package$;
/** @constructor */
function $h_Lmyapp_Modifier$package$() {
}
...
export { $d_Lmyapp_Modifier$package$ as $d_Lmyapp_Modifier$package$ };
var $n_Lmyapp_Modifier$package$;
function $m_Lmyapp_Modifier$package$() {
  if ((!$n_Lmyapp_Modifier$package$)) {
    $n_Lmyapp_Modifier$package$ = new $c_Lmyapp_Modifier$package$();
  }
  return $n_Lmyapp_Modifier$package$;
}
export { $m_Lmyapp_Modifier$package$ as $m_Lmyapp_Modifier$package$ };
