'use strict';
import * as $i_$0040awesome$002eme$002fwebawesome$002fdist$002fcomponents$002fbutton$002fbutton$002ejs from "@awesome.me/webawesome/dist/components/button/button.js";
import * as $i_$0040awesome$002eme$002fwebawesome$002fdist$002fstyles$002fwebawesome$002ecss from "@awesome.me/webawesome/dist/styles/webawesome.css";
...
function $f_Lcom_raquo_airstream_core_Named__defaultDisplayName__T($thiz) {
  return (($objectGetClass($thiz).getSimpleName__T() + "@") + $systemIdentityHashCode($thiz));
}
...
$c_Lcom_raquo_laminar_DomApi$.prototype.createHtmlElement__Lcom_raquo_laminar_tags_HtmlTag__Lorg_scalajs_dom_HTMLElement = (function(tag) {
  return document.createElement($n(tag).Lcom_raquo_laminar_tags_CustomHtmlTag__f_name);
});
...
/** @constructor */
function $c_Lcom_raquo_laminar_tags_CustomHtmlTag$() {
  $n_Lcom_raquo_laminar_tags_CustomHtmlTag$ = this;
  $m_Lcom_raquo_ew_JsArray$().apply__sci_Seq__Lcom_raquo_ew_JsArray($m_sr_ScalaRunTime$().wrapIntArray__AI__sci_ArraySeq(new $ac_I(new Int32Array([0]))));
}
$c_Lcom_raquo_laminar_tags_CustomHtmlTag$.prototype = new $h_O();
$c_Lcom_raquo_laminar_tags_CustomHtmlTag$.prototype.constructor = $c_Lcom_raquo_laminar_tags_CustomHtmlTag$;
/** @constructor */
function $h_Lcom_raquo_laminar_tags_CustomHtmlTag$() {
}
$h_Lcom_raquo_laminar_tags_CustomHtmlTag$.prototype = $c_Lcom_raquo_laminar_tags_CustomHtmlTag$.prototype;
$c_Lcom_raquo_laminar_tags_CustomHtmlTag$.prototype.$lessinit$greater$default$2__F1 = (function() {
  return new $c_sjsr_AnonFunction1_$$Lambda$3aa60c34ef08a878abffbf4628007cc68fa3c7ab(((_$1) => (void 0)));
});
var $d_Lcom_raquo_laminar_tags_CustomHtmlTag$ = new $TypeData().initClass($c_Lcom_raquo_laminar_tags_CustomHtmlTag$, "com.raquo.laminar.tags.CustomHtmlTag$", ({
  Lcom_raquo_laminar_tags_CustomHtmlTag$: 1
}));
var $n_Lcom_raquo_laminar_tags_CustomHtmlTag$;
function $m_Lcom_raquo_laminar_tags_CustomHtmlTag$() {
  if ((!$n_Lcom_raquo_laminar_tags_CustomHtmlTag$)) {
    $n_Lcom_raquo_laminar_tags_CustomHtmlTag$ = new $c_Lcom_raquo_laminar_tags_CustomHtmlTag$();
  }
  return $n_Lcom_raquo_laminar_tags_CustomHtmlTag$;
}
...
function $c_Lmain$package$() {
  ...
  $i_$0040awesome$002eme$002fwebawesome$002fdist$002fstyles$002fwebawesome$002ecss;
}
...
$c_Lmain$package$.prototype.run__V = (function() {
  ...
  var $x_3 = $m_Lio_github_nguyenyou_webawesome_laminar_Button$();
  var $x_2 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_F1.getArrayOf().constr)([]));
  ...
  var rootNode = $x_3.apply__sci_Seq__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($x_2, $x_1.wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_laminar_modifiers_Modifier.getArrayOf().constr)([$f_Lcom_raquo_laminar_api_Implicits__textToTextNode__O__Lcom_raquo_laminar_modifiers_RenderableText__Lcom_raquo_laminar_nodes_TextNode(this$1, "WebAwesome", r)])));
...
function $ct_Lcom_raquo_laminar_tags_HtmlTag__T__Z__($thiz, name, void$1) {
  return $thiz;
}
/** @constructor */
function $c_Lcom_raquo_laminar_tags_HtmlTag() {
}
...
function $ct_Lio_github_nguyenyou_webawesome_laminar_WebComponent__T__($thiz, tagName) {
  $thiz.Lio_github_nguyenyou_webawesome_laminar_WebComponent__f_tagName = tagName;
  $thiz.RawImport__sjs_js_Object();
  return $thiz;
}
/** @constructor */
function $c_Lio_github_nguyenyou_webawesome_laminar_WebComponent() {
  this.Lio_github_nguyenyou_webawesome_laminar_WebComponent__f_tagName = null;
  this.Lio_github_nguyenyou_webawesome_laminar_WebComponent__f_tag$lzy1 = null;
  this.Lio_github_nguyenyou_webawesome_laminar_WebComponent__f_tagbitmap$1 = false;
}
$c_Lio_github_nguyenyou_webawesome_laminar_WebComponent.prototype = new $h_O();
$c_Lio_github_nguyenyou_webawesome_laminar_WebComponent.prototype.constructor = $c_Lio_github_nguyenyou_webawesome_laminar_WebComponent;
/** @constructor */
function $h_Lio_github_nguyenyou_webawesome_laminar_WebComponent() {
}
$h_Lio_github_nguyenyou_webawesome_laminar_WebComponent.prototype = $c_Lio_github_nguyenyou_webawesome_laminar_WebComponent.prototype;
$c_Lio_github_nguyenyou_webawesome_laminar_WebComponent.prototype.tag__Lcom_raquo_laminar_tags_CustomHtmlTag = (function() {
  if ((!this.Lio_github_nguyenyou_webawesome_laminar_WebComponent__f_tagbitmap$1)) {
    this.Lio_github_nguyenyou_webawesome_laminar_WebComponent__f_tag$lzy1 = new $c_Lcom_raquo_laminar_tags_CustomHtmlTag(this.Lio_github_nguyenyou_webawesome_laminar_WebComponent__f_tagName, $m_Lcom_raquo_laminar_tags_CustomHtmlTag$().$lessinit$greater$default$2__F1(), ($m_Lcom_raquo_laminar_tags_CustomHtmlTag$(), (void 0)));
    this.Lio_github_nguyenyou_webawesome_laminar_WebComponent__f_tagbitmap$1 = true;
  }
  return this.Lio_github_nguyenyou_webawesome_laminar_WebComponent__f_tag$lzy1;
});
$c_Lio_github_nguyenyou_webawesome_laminar_WebComponent.prototype.apply__sci_Seq__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement = (function(componentMods, laminarMods) {
  var el = $n(this.tag__Lcom_raquo_laminar_tags_CustomHtmlTag()).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_laminar_modifiers_Modifier.getArrayOf().constr)([])));
  $n(componentMods).foreach__F1__V(new $c_sjsr_AnonFunction1_$$Lambda$3aa60c34ef08a878abffbf4628007cc68fa3c7ab(((_$1) => {
    var _$1$1 = $as_F1(_$1);
    $n($as_Lcom_raquo_laminar_modifiers_Modifier($n(_$1$1).apply__O__O(this))).apply__Lcom_raquo_laminar_nodes_ReactiveElement__V(el);
  })));
  $n(laminarMods).foreach__F1__V(new $c_sjsr_AnonFunction1_$$Lambda$3aa60c34ef08a878abffbf4628007cc68fa3c7ab(((_$2) => {
    var _$2$1 = $as_Lcom_raquo_laminar_modifiers_Modifier(_$2);
    $n(_$2$1).apply__Lcom_raquo_laminar_nodes_ReactiveElement__V(el);
  })));
  return el;
});
/** @constructor */
...
/** @constructor */
function $c_Lcom_raquo_laminar_tags_CustomHtmlTag(name, allowedInputControllerConfigIndices, allowableInputControllerConfigs) {
  this.Lcom_raquo_laminar_tags_CustomHtmlTag__f_name = null;
  this.Lcom_raquo_laminar_tags_CustomHtmlTag__f_name = name;
  $ct_Lcom_raquo_laminar_tags_HtmlTag__T__Z__(this, name, false);
}
$c_Lcom_raquo_laminar_tags_CustomHtmlTag.prototype = new $h_Lcom_raquo_laminar_tags_HtmlTag();
$c_Lcom_raquo_laminar_tags_CustomHtmlTag.prototype.constructor = $c_Lcom_raquo_laminar_tags_CustomHtmlTag;
/** @constructor */
function $h_Lcom_raquo_laminar_tags_CustomHtmlTag() {
}
...
/** @constructor */
function $c_Lio_github_nguyenyou_webawesome_laminar_Button$() {
  this.Lio_github_nguyenyou_webawesome_laminar_WebComponent__f_tagName = null;
  this.Lio_github_nguyenyou_webawesome_laminar_WebComponent__f_tag$lzy1 = null;
  this.Lio_github_nguyenyou_webawesome_laminar_WebComponent__f_tagbitmap$1 = false;
  $ct_Lio_github_nguyenyou_webawesome_laminar_WebComponent__T__(this, "wa-button");
}
$c_Lio_github_nguyenyou_webawesome_laminar_Button$.prototype = new $h_Lio_github_nguyenyou_webawesome_laminar_WebComponent();
$c_Lio_github_nguyenyou_webawesome_laminar_Button$.prototype.constructor = $c_Lio_github_nguyenyou_webawesome_laminar_Button$;
/** @constructor */
function $h_Lio_github_nguyenyou_webawesome_laminar_Button$() {
}
$h_Lio_github_nguyenyou_webawesome_laminar_Button$.prototype = $c_Lio_github_nguyenyou_webawesome_laminar_Button$.prototype;
$c_Lio_github_nguyenyou_webawesome_laminar_Button$.prototype.RawImport__sjs_js_Object = (function() {
  return $i_$0040awesome$002eme$002fwebawesome$002fdist$002fcomponents$002fbutton$002fbutton$002ejs;
});
var $d_Lio_github_nguyenyou_webawesome_laminar_Button$ = new $TypeData().initClass($c_Lio_github_nguyenyou_webawesome_laminar_Button$, "io.github.nguyenyou.webawesome.laminar.Button$", ({
  Lio_github_nguyenyou_webawesome_laminar_Button$: 1,
  Lio_github_nguyenyou_webawesome_laminar_WebComponent: 1,
  Lio_github_nguyenyou_webawesome_laminar_CommonTypes: 1
}));
var $n_Lio_github_nguyenyou_webawesome_laminar_Button$;
function $m_Lio_github_nguyenyou_webawesome_laminar_Button$() {
  if ((!$n_Lio_github_nguyenyou_webawesome_laminar_Button$)) {
    $n_Lio_github_nguyenyou_webawesome_laminar_Button$ = new $c_Lio_github_nguyenyou_webawesome_laminar_Button$();
  }
  return $n_Lio_github_nguyenyou_webawesome_laminar_Button$;
}
...
$c_Lcom_raquo_laminar_nodes_ReactiveHtmlElement.prototype.toString__T = (function() {
  return (("ReactiveHtmlElement(" + ((this.Lcom_raquo_laminar_nodes_ReactiveHtmlElement__f_ref !== null) ? $as_T(this.Lcom_raquo_laminar_nodes_ReactiveHtmlElement__f_ref.outerHTML) : ("tag=" + $n(this.Lcom_raquo_laminar_nodes_ReactiveHtmlElement__f_tag).Lcom_raquo_laminar_tags_CustomHtmlTag__f_name))) + ")");
});
